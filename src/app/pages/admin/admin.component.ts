...
export class AdminComponent implements OnInit {
  ...
  async reload(): Promise<void> {
    try {
      ...
      if (!this.form.controls.category.value && this.categories.length > 0) {
  ...
  async save(): Promise<void> {
    ...
    const formValue = this.form.getRawValue(); // ✅ tipuri fără null

    try {
      this.saving = true;

      if (this.editId) {
        await this.productsDb.update(this.editId, formValue);
